...
import {Diversity3 as TeamWorkIcon,Code as CodeIcon, Palette as DesignIcon, Speed as SpeedIcon } from "@mui/icons-material"
    ...
    return (
        <StyleMainContainerBox id="about" >
            <Container maxWidth="lg">
                <StyleTitleTypography variant="h3" component="h2" textAlign="center" gutterBottom>
                    About Me
                ...
                <Grid container spacing={4} alignItems="center">
                    <Grid>
                        <Typography variant="body1"  sx={{ fontSize: "1.1rem", lineHeight: 1.8, mb: 2 }}>
                            ...
                            myself up-to-date with cutting edge technologies. I am good at being a team player as well as
                            leading a team. I am more keen on Web development and Mobile Development. I am Hardworking
                            individual who likes to face difficult situations which open up new opportunities. and highly
                            motivated to improve my skills and have experience in working with clients to ensure their best satisfaction.
                        </Typography>
